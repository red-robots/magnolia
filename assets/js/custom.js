...
jQuery(document).ready(function ($) {
  var unAnimateLogo = function unAnimateLogo() {
  ...
  var animateTaglineBorder = function animateTaglineBorder() {
  ...
  $(window).scroll(function () {
    ...
    if (scroll >= 200) {
      $("body").addClass('scrolled'); // $(".tagline.orig").removeClass('animated');
  ...
  $(document).on('click', function (e) {
    ...
    if ($(target).hasClass('menutoggle') || $(parent).hasClass('menutoggle')) {//return false;
    } else {
  ...
  $(document).click(function (e) {
    var container = $("#shareitBtn"); // If the target of the click isn't the container
